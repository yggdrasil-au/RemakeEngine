...
def create_module_conf(module_name: str, project_ini_path: Path, mode: str, module_dir) -> tuple[Path, configparser.ConfigParser]:
    ...
    conf_path = module_dir / "blendConf.ini"
    ...
    conf['Directories'] = {
        "BlenderExePath": str(module_dir / "Tools/blender/exe/blender-4.0.2-windows-x64/blender.exe"),
        "python_script_path": str(module_dir / "Tools/blender/main.py"),
        "python_extension_file": str(module_dir / "Tools/blender/io_import_simpson_game_fork.py"),
        "asset_mapping_file": str(module_dir / "Tools/process/asset_mapping.json")
    }
