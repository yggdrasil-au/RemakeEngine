...
MAIN_HEADER = b'\x16\x00\x00\x00'
START_OF_FIRST_SEGMENT = b'\x2D\x00\x02\x1C\x01\x00\x00\x00\x04\x00\x00\x00\x2D\x00\x02\x1C'
START_END_DATA_SEGMENT = b'\x14\x00\x00\x00\x2D\x00\x02\x1C\x2F\xEA\x00\x00\x08\x00\x00\x00\x2D\x00\x02\x1C'
START_END_DATA_SEGMENT = MAIN_HEADER
...
LEN_BYTES_A = 4
LEN_BYTES_B = 4 # indicates the four possible values before the name of the textures
LEN_BYTES_C = 4 # this is the block of bytes that contains the name of the textures
LEN_BYTES_D = 4
LEN_BYTES_E = 4
LEN_BYTES_F = 4
LEN_BYTES_G = 80
