...
def main_cli():
	...
	while True:
		...
		if not available_games:
			# This line was already in the correct format
			print(colour=Colours.RED, message="No valid game configurations found.")
			return
		...
		while True:
			...
			if any(op.get("run-all") for op in operations):
				menu_choices.append("Run All Marked Operations")
