...
public static class OperationOutputService {
    ...
    /// </summary>
    internal static ObservableCollection<OutputLine> Lines { get; } = new ObservableCollection<OutputLine>();
    ...
    public static void HandleEvent(Dictionary<string, object?> evt) {
        ...
        global::Avalonia.Threading.Dispatcher.UIThread.Post(() => {
            switch (evtType) {
                ...
                case "progress":
                    int current = evt.TryGetValue("current", out object? cur) ? System.Convert.ToInt32(cur) : 0;
                    int total = evt.TryGetValue("total", out object? tot) ? System.Convert.ToInt32(tot) : 0;
    ...
    /// </summary>
    private static string FormatEventData(System.Collections.Generic.Dictionary<string, object?> evt) {
