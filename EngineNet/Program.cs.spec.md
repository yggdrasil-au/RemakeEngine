...
- Walk up the directory tree from CWD or base directory to find a folder containing <span style="color: #F57C00;"><mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">RemakeRegistry/Games/</mark></span> (project marker).
...
- <mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">private static IToolResolver CreateToolResolver(string root)</mark>
  - Checks for tool config files in precedence order:
    ...
    3. <span style="color: #F57C00;"><mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">&lt;root&gt;/RemakeRegistry/Tools.json</mark></span>
    4. <span style="color: #F57C00;"><mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">&lt;root&gt;/RemakeRegistry/tools.json</mark></span>
...
- File system:
  ...
  - <span style="color: #F57C00;"><mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">&lt;root&gt;/RemakeRegistry/Games/</mark></span> — Project root marker (directory existence check).
...
3. **<span style="color: #2E7D32;">Tool Resolver Precedence</span>**: Always checks <mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">Tools.local.json</mark> → <mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">tools.local.json</mark> → <mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">RemakeRegistry/Tools.json</mark> → <mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">RemakeRegistry/tools.json</mark> → passthrough (in that order).
...
- **<span style="color: #F57C00;">No RemakeRegistry/Games Found</span>**: Falls back to CWD as root; engine may fail later if operations require registry.
...
- <mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">CreateToolResolver_Uses_RemakeRegistry_ToolsJson_When_NoLocal</mark>: Confirms fallback to <span style="color: #F57C00;"><mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">RemakeRegistry/Tools.json</mark></span>.
- <mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">CreateToolResolver_FallsBack_To_RemakeRegistry_lowercase_tools</mark>: Checks <span style="color: #F57C00;"><mark style="background-color: rgba(0, 0, 0, 0); color: #ffffffff; border: 1px dotted; border-radius: 3px; padding: 0 3px;">RemakeRegistry/tools.json</mark></span> (lowercase).
