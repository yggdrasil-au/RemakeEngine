...
internal static class EmbeddedActionDispatcher {
    internal static Core.ScriptEngines.Helpers.IAction? TryCreate(
        string scriptType,
        string scriptPath,
        ...
        switch (t) {
            case "lua":
                return new Core.ScriptEngines.LuaScriptAction(scriptPath: scriptPath, args: args);
            case "js":
                return new Core.ScriptEngines.JsScriptAction(scriptPath: scriptPath, args: args);
            case "bms": {
                ...
                return new Core.ScriptEngines.QuickBmsScriptAction(
