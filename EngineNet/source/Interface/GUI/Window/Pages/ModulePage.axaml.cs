...
public sealed partial class ModulePage:UserControl, INotifyPropertyChanged {
    ...
    private void Load() {
        try {
            ...
            if (m is not null) {
                ...
                Title = _moduleName;
                Image = ResolveCoverBitmap(gameRoot: EngineNet.Core.Lib.RootPath);
            }
    ...
    private Bitmap? ResolveCoverBitmap(string? gameRoot) {
        ...
        string placeholder = System.IO.Path.Combine(path1: EngineNet.Core.Lib.RootPath, path2: "placeholder.png");
    ...
    private bool IsDownloaded() {
        ...
        string path = System.IO.Path.Combine(path1: EngineNet.Core.Lib.RootPath, path2: System.IO.Path.Combine("EngineApps", "Games", _moduleName));
