...
internal sealed partial class PythonScriptAction : Helpers.IAction {
    ...
    internal PythonScriptAction(string scriptPath, System.Collections.Generic.IEnumerable<string>? args) {
    ...
    public async System.Threading.Tasks.Task ExecuteAsync(Core.Tools.IToolResolver tools, System.Threading.CancellationToken cancellationToken = default) {
        ...
        Core.Utils.EngineSdk.PrintLine(message: $"Running python script '{_scriptPath}' with {_args.Length} args...", color: System.ConsoleColor.Cyan);
