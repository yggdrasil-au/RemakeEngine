...
internal sealed partial class JsScriptAction : ScriptEngines.Helpers.IAction {
    ...
    private void SetupCoreFunctions(JsWorld JSEnvObj, Core.ExternalTools.IToolResolver tools) {
        ...
        JSEnvObj.JsEngineScript.SetValue("tool", (Func<string, string>)tools.ResolveToolPath);
        JSEnvObj.JsEngineScript.SetValue("ResolveToolPath", (Func<string, string>)tools.ResolveToolPath);
