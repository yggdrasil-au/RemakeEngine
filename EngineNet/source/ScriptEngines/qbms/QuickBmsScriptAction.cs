...
public sealed class Main : ScriptEngines.IAction {
    ...
    public async System.Threading.Tasks.Task ExecuteAsync(Core.ExternalTools.JsonToolResolver tools, Core.Services.CommandService commandService, System.Threading.CancellationToken cancellationToken = default) {
        ...
        (string? installedExe, string? installedVersion) = Core.ExternalTools.ToolMetadataProvider.ResolveExeAndVersion(toolId: "QuickBMS", EngineNet.Core.Main.RootPath, tools);
