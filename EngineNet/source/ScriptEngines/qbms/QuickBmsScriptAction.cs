...
public sealed class Main : IScriptAction {
    ...
    public async System.Threading.Tasks.Task ExecuteAsync(Core.Abstractions.IJsonToolResolver tools, Core.Abstractions.ICommandService commandService, System.Threading.CancellationToken cancellationToken = default(CancellationToken)) {
