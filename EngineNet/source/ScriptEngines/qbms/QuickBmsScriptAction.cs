...
public sealed class Main : IScriptAction {
    ...
    public async System.Threading.Tasks.Task ExecuteAsync(Core.ExternalTools.JsonToolResolver tools, Core.Services.CommandService.CommandService commandService, System.Threading.CancellationToken cancellationToken = default(CancellationToken)) {
