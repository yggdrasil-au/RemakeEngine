...
internal static class Helpers {
    ...
    internal static class AddConfigurationHelpers {
        internal static bool Validate_Source_Dir(string dir) {
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("validate_source_dir failed with exception: " + ex);
                return false;
            }
        }
    }
    ...
    internal static class AddFileSystemOperations {
        internal static Dictionary<string, object>? FileAttributes(string path) {
            ...
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("FileAttributes helper failed with exception: " + ex);
                return null;
            }
        }
        ...
        internal static List<string>? List_Dir(string path) {
            ...
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("list_dir helper failed with exception: " + ex);
                return null;
            }
        }
    ...
    internal static class AddHashMethods {
        ...
        internal static dynamic? sha1_file(string path) {
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("sha1_file failed with exception: " + ex);
                return null;
            }
        }
        ...
        internal static string Md5Hash(string text) {
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("md5 failed with exception: " + ex);
                return string.Empty;
            }
        }
    }
    ...
    internal static void Sleep(double seconds) {
        ...
        try {
            ...
            Shared.IO.Diagnostics.LuaInternalCatch("sleep failed with exception: " + ex);
        }
    }
    ...
    internal static class AddArchiveOperations {
        internal static bool Extract_Archive(string archivePath, string destDir) {
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("extract_archive failed with exception: " + ex);
                return false;
            }
        }
        ...
        internal static bool Create_Archive(string srcPath, string archivePath, string type) {
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("create_archive failed with exception: " + ex);
                return false;
            }
        }
    }
    ...
    internal static class AddTomlHelpers {
        internal static object? Toml_Read_File(string path) {
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("toml_read_file failed with exception: " + ex);
                return null; //DynValue.Nil;
            }
        }
        ...
        internal static void Toml_Write_File(string path, object? obj) {
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("toml_write_file failed with exception: " + ex);
            }
        }
    ...
    internal static class AddYamlHelpers {
        internal static object? Yaml_Read_File(string path) {
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("yaml_read_file failed with exception: " + ex);
                return null;
            }
        }
        ...
        internal static void Yaml_Write_File(string path, object? obj) {
            try {
                ...
                Shared.IO.Diagnostics.LuaInternalCatch("yaml_write_file failed with exception: " + ex);
            }
        }
    }
}
