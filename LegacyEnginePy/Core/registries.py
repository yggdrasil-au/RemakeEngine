...
class Registries:
    ...
    def discover_games(self) -> Dict[str, GameInfo]:
        """
        Discovers game directories and their associated operation files.
        The directory name is used as the canonical game name.
        """
        ...
        for game_dir in self.games_registry_path.iterdir():
            ...
            if game_dir.is_dir() and ops_file.is_file():
                # Use the directory name as the game name, as it matches the registry.
